...
coronavirus$Country.Region[coronavirus$Country.Region == "Burma"] <- "Myanmar"
...
df <- coronavirus %>%
  ...
  dplyr::filter(Country.Region == "Myanmar") %>%
...
### **Daily cumulative cases by type** (Myanmar only)
...
**The Coronavirus Dashboard: the case of Myanmar**

This Coronavirus dashboard: the case of Myanmar provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Myanmar. This dashboard is built with R using the R Makrdown framework and was initially adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin and then by this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html){target="_blank"} by Antoine Soetewey.
